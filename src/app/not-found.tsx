  ...
  return (
    <main className="flex min-h-screen bg-white px-4 py-12.5 md:px-35">
      <section className="flex w-full flex-col items-start justify-center gap-6 rounded-[30px] bg-[#F7F7F7] px-6 py-10 md:min-h-110 md:px-10 md:py-12">
        <BodyText
          as="span"
          className="inline-flex rounded-full bg-white px-4 py-2 font-medium text-[#565EEF] shadow-[0px_4px_20px_-12px_rgba(0,0,0,0.2)]"
        >
          Ошибка 404
        </BodyText>

        <div className="flex max-w-160 flex-col gap-4">
          <SectionTitle as="h1" className="max-w-120 md:text-[56px]">
            Страница не найдена
          </SectionTitle>
          <BodyText className="max-w-110 leading-tight text-[#565EEF]">
